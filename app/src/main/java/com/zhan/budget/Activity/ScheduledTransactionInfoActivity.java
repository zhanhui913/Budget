...
public class ScheduledTransactionInfoActivity extends BaseActivity implements
    ...
    public static final String EDIT_SCHEDULED_TRANSACTION_ITEM = "Edit Scheduled Transaction Item";

    public static final String SCHEDULED_TRANSACTION_DATE = "Scheduled Transaction Date";

    public static final String RESULT_SCHEDULED_TRANSACTION = "Result Scheduled Transaction";
    ...
    public static Intent createIntentForNewScheduledTransaction(Context context, Date date) {
        Intent intent = new Intent(context, ScheduledTransactionInfoActivity.class);
        intent.putExtra(NEW_SCHEDULED_TRANSACTION, true);
        intent.putExtra(SCHEDULED_TRANSACTION_DATE, date);
        return intent;
    }

    public static Intent createIntentToEditScheduledTransaction(Context context, ScheduledTransaction scheduledTransaction) {
        Intent intent = new Intent(context, ScheduledTransactionInfoActivity.class);
    ...
    protected int getActivityLayout(){
        return R.layout.activity_scheduled_transaction_info;
    }
