...
public class AccountListAdapter1 extends RecyclerView.Adapter<AccountListAdapter1.ViewHolder> {
    ...
    public AccountListAdapter1(Fragment fragment, List<Account> accountList, boolean displayCost) {
    ...
    public AccountListAdapter1(Activity activity, List<Account> accountList, boolean displayCost){
