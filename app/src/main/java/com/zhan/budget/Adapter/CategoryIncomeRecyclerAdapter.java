 ...
 */
public class CategoryIncomeRecyclerAdapter extends RecyclerView.Adapter<CategoryIncomeRecyclerAdapter.ViewHolder>
    ...
    public CategoryIncomeRecyclerAdapter(Fragment fragment, List<Category> list, OnStartDragListener startDragListener) {
        ...
        if (fragment instanceof OnCategoryIncomeAdapterInteractionListener) {
            mListener = (OnCategoryIncomeAdapterInteractionListener) fragment;
        } else {
            throw new RuntimeException(fragment.toString() + " must implement OnCategoryIncomeAdapterInteractionListener.");
        }
    }
    ...
    public interface OnCategoryIncomeAdapterInteractionListener {
